...
# These guys have other duties like mining for resources 
# (let's not worry about that for now)
# For our intents and purposes, Peasants are just another Unit 
# which have lower HP and no AP 
# (they can't attack other units)
